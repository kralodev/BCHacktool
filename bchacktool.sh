...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo -e $cyan"    Instagram           $white":" $red o yok$tp"
    echo -e $cyan"    Developer           $white":" $red ErRPasT$tp"
    exit 0
fi
...
ctrl_c() {
echo -e "\n"
echo -e "[${blink}${yellow}*${tp}]$blue BCHackTool Programini Tercih Ettiginiz Için Teşekkürler   :)$tp"
exit 0
}
