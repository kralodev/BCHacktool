...
if [[ $1 =~ ^(-h|--help|-y|--yardım) ]] ; then
    ...
    echo "----------------------------------------------------------"
    echo -e $cyan"    Create by           $white":" $red ErRPasT$tp"
    echo -e $cyan"    Github              $white":" $red https://github.com/Kralodev$tp"
    echo -e $cyan"    Instagram           $white":" $red yok$tp"
    echo -e "$cyan    Discord            $white : $red --şimdi olmaz--$tp"
    echo -e "$cyan    Tester             $white : $red sanane aq$tp"
    echo -e "$cyan    Developper         $white : $red https://github.com/kralodev$tp"
    exit 0
...
echo -e "${blink}${lightgreen}  |$tp ${cyan}Create by           $white":" $red ErRPasT$tp ${blink}${lightgreen}                        |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Discord             $white":" $red sanane aq$tp${blink}${lightgreen}      |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Github              $white":" $red https://github.com/Kralodev$tp ${blink}${lightgreen}     |$tp"
echo -e "${blink}${lightgreen}  |$tp ${cyan}Instagram           $white":" $red yok$tp ${blink}${lightgreen}                  |$tp"
echo -e "${blink}${lightgreen}  ---------------------------------------------------------$tp\n"
echo " ~~~~~~~~~~~~~~~~~~~~~ BCHackTool Termux ~~~~~~~~~~~~~~~~~~~~~~~~~"
        echo ""
        echo " [1] ✔ BluForce-FB" 
        echo " [2] ✔ Cupp" 
        echo " [3] ✔ SpamWa" 
